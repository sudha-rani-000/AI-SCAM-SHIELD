/**
 * Fully client-side URL analysis. Everything here is derived directly
 * from the URL string itself (protocol, hostname structure, known
 * shortener/TLD lists, keyword patterns) — there's no live threat-feed
 * lookup, so treat the result as a first-pass structural check, not a
 * verified reputation lookup.
 */
